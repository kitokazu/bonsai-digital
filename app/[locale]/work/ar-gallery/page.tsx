...
/* The first slot is the 3D viewer being orbited, captured from the running app
   and played back as a loop. Everything else is a still. */
const showcaseMedia = [
  { type: "video" as const, src: "/ar-gallery/orbit", poster: "/ar-gallery/orbit-poster.jpg" },
  { type: "image" as const, src: "/ar-gallery/starry-night.jpg" },
  { type: "image" as const, src: "/ar-gallery/collection.jpg" },
  { type: "image" as const, src: "/ar-gallery/pearl-earring.jpg" },
];
