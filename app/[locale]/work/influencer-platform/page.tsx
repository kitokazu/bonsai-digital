...
const showcaseImages = [
  "/uncharted/google-sheets.png",
  "/uncharted/creator-info.png",
  "/uncharted/creators.png",
  "/uncharted/campaign-matching.png",
];

export default function InfluencerPlatformPage() {
  const { t, locale } = useTranslation();
  const d = t.workDetail.influencerAgency;
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto max-w-5xl">
          <div
            ...
            style={{ viewTransitionName: "wt-influencerAgency" }}
          >
            <Image
              src="/uncharted/dashboard.png"
              alt="Uncharted influencer dashboard"
              width={1200}
              height={874}
