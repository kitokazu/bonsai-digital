...
const showcaseImages = [
  { image: "/cashflowAI/chatbot-page.png", format: "desktop" as const },
  { image: "/cashflowAI/dashboard-page.png", format: "desktop" as const },
  { image: "/cashflowAI/automations.png", format: "desktop" as const },
  { image: "/cashflowAI/architecture.png", format: "tablet" as const },
];

export default function CashFlowAIPage() {
  const { t, locale } = useTranslation();
  const d = t.workDetail.cashflowai;
